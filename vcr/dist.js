...
const click = (element, resolve) => {
  $(element).trigger('click');
  resolve();
};

const keypress = (element, which, resolve) => {
...
const fire = ({ type, which, path }) => {
  return new Promise(resolve => {
    ...
    new Promise(resolve => {
      ...
      if (type === 'click') click(element, resolve);else if (type === 'keypress') keypress(element, which, resolve);
    }).then(() => {
      attachHandlers();
      resolve();
    });
