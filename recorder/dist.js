...
var play = function play() {
    return playEventsRecursively(0);
};
...
var stopRecording = function stopRecording() {
    detachHandlers();
    isRecording = false;
    localStorage.vhs = { events: events };
};
