...
var render = function render(events, lastEventIndex) {
    ...
    for (var i = 0; i < events.length; i++) {
        addEvent(events[i], i <= lastEventIndex ? 'passed' : 'pending');
    }followLogs();
};
...
var addEvent = function addEvent(event, status) {
    event.status = status;
